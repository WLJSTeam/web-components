...
processRequest[controls_, modals_, messager_, client_] := With[{
    ...
    With[{
        ...
        With[{
            ...
            EventFire[modals, "SelectBox", <|"Promise"->p, "title"->"Export options", "message"->"Please, choose one below", "list"->{"Static HTML","Interactive HTML", "Markdown", "Slides", "Static MDX", "Interactive MDX", "Mini app", "Mathematica"}|>];
            Then[p, Function[choise,
                ...
                With[{},
                    Then[collectStaticData[client, messager, notebookOnLine], Function[Null,
                        Echo["Export >>"];
                        {html`Static`export, html`Dynamic`export, markdown`export, slides`export, mdx`Static`export, mdx`Dynamic`export, wlw`export, mathematica`export}[[choise ]][controls, modals, messager, client, notebookOnLine, path, name, ext, settings, <|
