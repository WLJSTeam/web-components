...
Options[MessageDialog] = {"Title"->"", "Window" :> CurrentWindow[], "Notebook" :> RemoteNotebook[ System`$EvaluationContext["Notebook"] ]}


Options[ChoiceDialog] = {"Title"->"", "Window" :> CurrentWindow[], "Notebook" :> RemoteNotebook[ System`$EvaluationContext["Notebook"] ]}
...
InputStringAsync[prompt_:"Input text", initial_:"", opts: OptionsPattern[] ] := With[{
...
Options[InputStringAsync] = {"Window" :> CurrentWindow[], "Notebook" :> RemoteNotebook[ System`$EvaluationContext["Notebook"] ]}
