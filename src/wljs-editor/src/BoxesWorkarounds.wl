...
Iconize /: MakeBoxes[Iconize[expr_, opts: OptionsPattern[] ], StandardForm] := With[{UID = StringTake[CreateUUID[],3], title = OptionValue[Iconize, opts, "Label"]},
  If[ByteCount[expr] > 3800,
    With[{name = title<>"-"<>UID<>".wl"},
      If[!DirectoryQ[".iconized"],  CreateDirectory[FileNameJoin[{Directory[], ".iconized"}] ]  ];
      Put[expr // Compress, FileNameJoin[{".iconized", name}] ];
      With[{c = {".iconized", name}, b = ByteCount[expr]},
        RowBox[{"(*VB[*)(Uncompress@Get[FileNameJoin[", ToString[c, InputForm], "]])(*,*)(*", ToString[Compress[ ViewDecorator["Iconized", b, "Label"->title, "File"->True] ], InputForm], "*)(*]VB*)"}]
      ]
    ]
  ,
    With[{c = expr // Compress, b = ByteCount[expr]},
      RowBox[{"(*VB[*)(Uncompress[", ToString[c, InputForm], "])(*,*)(*", ToString[Compress[ ViewDecorator["Iconized", b, "Label"->title] ], InputForm], "*)(*]VB*)"}]
    ]
  ]
]

Iconize /: MakeBoxes[Iconize[expr_, title_String], StandardForm] := With[{},
  MakeBoxes[Iconize[expr, "Label" -> title], StandardForm]
]
...
BoxForm`failureIcon = Uncompress["1:"];
...
Failure /: MakeBoxes[f:Failure[__], form: StandardForm] := With[{
  ...
  With[{msg = If[MemberQ[f["Properties"] , "MessageParameters"] && MemberQ[f["Properties"] , "MessageTemplate"], StringTemplate[f @ "MessageTemplate"] @ params, "Generic"]},
    BoxForm`ArrangeSummaryBox[
                 Failure, (* head *)
                 f,      (* interpretation *)
...
Failure /: MakeBoxes[f:Failure[_, command_Association], form: StandardForm] := With[{
  ...
  With[{msg = If[MemberQ[f["Properties"] , "MessageParameters"] && MemberQ[f["Properties"] , "MessageTemplate"], StringTemplate[f @ "MessageTemplate"] @ params, Lookup[command, "StandardError", "Generic"] ]},
    BoxForm`ArrangeSummaryBox[
                 Failure, (* head *)
                 f,      (* interpretation *)
                 BoxForm`failureIcon,    (* icon, use None if not needed *)
